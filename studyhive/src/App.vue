...
<template>
  <div class="bg-white">
        ...
        >
          <div class="flex justify-between w-[90%]">
            ...
            <ul class="flex gap-[3rem] items-center">
              ...
              <RouterLink to="/StudySets" class="text-xl font-semibold text-black"
                >Study Sets</RouterLink
              >
    ...
    <div @click="" class="fixed z-100 bottom-4 right-10 cursor-pointer">
      <div class="w-24 h-24 bg-amber-500 rounded-[30rem]">🡡</div>
      <h3>scroll up</h3>
    </div>
